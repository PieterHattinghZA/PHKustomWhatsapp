...
A Windows PowerShell 5.1 toolkit and two-column Windows Forms client for messaging through Green API.

## Highlights

- Retrieves recent active chats through the Green API getChats method.
- Resolves active chats against the account contact list.
